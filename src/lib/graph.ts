...
export function createWorldGraph(): { cities: City[], roads: Road[] } {
  ...
  const roads: Road[] = [
    ...
    { from: "rust_town", to: "metal_hill", length: 2, risk: 0.3 },
    { from: "dusty_oasis", to: "bottle_cap_canyon", length: 3, risk: 0.4 },
    // Вертикальные связи  
    { from: "rust_town", to: "dusty_oasis", length: 2, risk: 0.3 },
    { from: "metal_hill", to: "bottle_cap_canyon", length: 2, risk: 0.3 }
  ];
